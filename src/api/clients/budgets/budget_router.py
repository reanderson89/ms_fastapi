...
@router.get("/clients/{client_uuid}/budgets/{budget_7char}", response_model=ClientBudgetModel)
async def get_budget(budget_7char: str):
	return CommonRoutes.get_one(ClientBudgetModel, budget_7char)
...
@router.put("/clients/{client_uuid}/budgets/{budget_7char}", response_model=ClientBudgetModel)
async def update_budget(budget_7char: str, budget_updates: ClientBudgetUpdate):
	return CommonRoutes.update_one(budget_7char, ClientBudgetModel, budget_updates)
...
async def delete_budget(budget_7char: str):
	return CommonRoutes.delete_one(budget_7char, ClientBudgetModel)
