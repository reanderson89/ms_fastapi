...
@router.get("/clients/{client_uuid}/awards/{award_uuid}")
async def get_award(award_uuid: int):
...
@router.put("/clients/{client_uuid}/awards/{award_uuid}")
async def update_award(award_uuid: int):
...
@router.delete("/clients/{client_uuid}/awards/{award_uuid}")
async def delete_award(award_uuid: int):
