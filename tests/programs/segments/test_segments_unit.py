...
def test_get_segments():
	...
	response = client.get(f"/clients/{client_uuid}/programs/{program_7char}/segments")
...
def test_get_segment():
	...
	response = client.get(f"/clients/{client_uuid}/programs/{program_7char}/segments/{segment_7char}")
	assert response.status_code == 200
...
def test_create_segment():
	client_uuid = "test_client_uuid"
	program_7char = "testchr"
	response = client.post(f"/clients/{client_uuid}/programs/{program_7char}/segments")
	assert response.status_code == 200
...
def test_update_segment():
	...
	program_7char = "testchr"
	segment_7char = "testchr"
	response = client.put(f"/clients/{client_uuid}/programs/{program_7char}/segments/{segment_7char}")
	assert response.status_code == 200
...
def test_delete_segment():
	...
	program_7char = "testchr"
	segment_7char = "testchr"
	response = client.delete(f"/clients/{client_uuid}/programs/{program_7char}/segments/{segment_7char}")
	assert response.status_code == 200
