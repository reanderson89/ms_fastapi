...
async def test_integration_create_award():
	...
	async with httpx.AsyncClient(app=app, base_url="http://test") as ac:
		response = await ac.post(f"clients/{client_uuid}/programs/{program_7char}/segments/{segment_7char}/awards")
...
async def test_integration_get_awards():
	...
	segment_7char = "testchr"
	async with httpx.AsyncClient(app=app, base_url="http://test") as ac:
		response = await ac.get(f"clients/{client_uuid}/programs/{program_7char}/segments/{segment_7char}/awards")
		assert response.status_code == 200
...
async def test_integration_get_award():
	...
	award_7char = "testchr"
	async with httpx.AsyncClient(app=app, base_url="http://test") as ac:
		response = await ac.get(f"clients/{client_uuid}/programs/{program_7char}/segments/{segment_7char}/awards/{award_7char}")
		assert response.status_code == 200
...
async def test_integration_update_award():
	...
	award_7char = "testchr"
	async with httpx.AsyncClient(app=app, base_url="http://test") as ac:
		response = await ac.put(f"clients/{client_uuid}/programs/{program_7char}/segments/{segment_7char}/awards/{award_7char}")
		assert response.status_code == 200
...
async def test_integration_delete_award():
	...
	award_7char = "testchr"
	async with httpx.AsyncClient(app=app, base_url="http://test") as ac:
		response = await ac.delete(f"clients/{client_uuid}/programs/{program_7char}/segments/{segment_7char}/awards/{award_7char}")
		assert response.status_code == 200
