...
async def test_integration_create_message():
	...
	async with httpx.AsyncClient(app=app, base_url="http://test") as ac:
		response = await ac.post(f"clients/{client_uuid}/programs/{program_7char}/messages")
...
async def test_integration_get_messages():
	...
	program_7char = "testchr"
	async with httpx.AsyncClient(app=app, base_url="http://test") as ac:
		response = await ac.get(f"clients/{client_uuid}/programs/{program_7char}/messages")
		assert response.status_code == 200
...
async def test_integration_get_message():
	...
	async with httpx.AsyncClient(app=app, base_url="http://test") as ac:
		response = await ac.get(f"clients/{client_uuid}/programs/{program_7char}/messages/{message_7char}")
		assert response.status_code == 200
...
async def test_integration_create_template_message():
	...
	message_7char = "testchr"
	async with httpx.AsyncClient(app=app, base_url="http://test") as ac:
		response = await ac.post(f"clients/{client_uuid}/programs/{program_7char}/messages/{message_7char}")
		assert response.status_code == 200
...
async def test_integration_send_message():
	...
	message_7char = "testchr"
	async with httpx.AsyncClient(app=app, base_url="http://test") as ac:
		response = await ac.post(f"clients/{client_uuid}/programs/{program_7char}/messages/{message_7char}/send")
		assert response.status_code == 200
...
async def test_integration_upate_message():
	...
	message_7char = "testchr"
	async with httpx.AsyncClient(app=app, base_url="http://test") as ac:
		response = await ac.put(f"clients/{client_uuid}/programs/{program_7char}/messages/{message_7char}")
		assert response.status_code == 200
