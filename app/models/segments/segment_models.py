...
class SegmentModel(SQLModel, table=False):
	...
	client_uuid: str = Field(default=None, index=True, foreign_key="client.uuid", max_length=65)
	program_9char: str = Field(default=None, index=True, foreign_key="program.program_9char", max_length=9)
	segment_9char: str = Field(default=None, index=True, foreign_key="segment.segment_9char", max_length=9)
	budget_9char: str = Field(default=None, index=True, foreign_key="client_budget.budget_9char", max_length=9)
