...
class UsersServiceModel(SQLModel, table=True):
	...
	#service_user_id: List[EmailStr] = Field(default_factory=lambda:[], index=True, max_length=255, description="user email address")
	service_user_id: EmailStr = Field(default=None, index=True)
